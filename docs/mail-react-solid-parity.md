...
- a separate diff between the exact 0.8.0 Mail source and current upstream main.
...
For the React reference, prepare the ignored exact checkout and launch its source:
    ...
    cd .cache/gpuix/remorses--gpuix-8d3ec0943871
