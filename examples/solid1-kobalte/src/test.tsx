...
if (!hasNativeTestRenderer) {
  ...
  requireCondition(app.renderer.hasTestId("button-disabled"), "disabled Button adapter should remain covered without adding fixture chrome")
  ...
  requireCondition(app.renderer.styleTestId("avatar-jm-content").borderRadius === 28, "Image fallback itself should be clipped to the Kobalte circle")
  ...
  requireCondition(app.renderer.styleTestId("dialog-overlay").top === 0, "Dialog overlay should start at the native window top")
  requireCondition(app.renderer.styleTestId("dialog-overlay").bottom === 0, "Dialog overlay should extend to the native window bottom")
