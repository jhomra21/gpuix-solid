...
export const kobalteNativeAliases: Alias[] = [
  ...
  { find: /^@solid1-daw\/native-waveform$/, replacement: compat("NativeWaveformSvg.tsx") },
  ...
  { find: /^@daw-browser\/timeline-core\/audio-clip-time-map$/, replacement: upstream("packages/timeline-core/audio-clip-time-map.ts") },
  ...
  { find: /^@daw-browser\/timeline-core\/types$/, replacement: upstream("packages/timeline-core/types.ts") },
  { find: /^@daw-browser\/timeline-core\/clip-fades$/, replacement: upstream("packages/timeline-core/clip-fades.ts") },
  ...
  { find: /^~\/lib\/timeline-range-selection$/, replacement: upstream("lib/timeline-range-selection.ts") },
