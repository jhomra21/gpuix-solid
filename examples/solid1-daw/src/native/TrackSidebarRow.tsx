        ...
        <div style={{ width: 94, minWidth: 94, display: "flex", alignItems: "flex-start", gap: 4, overflow: "hidden" }}>
          <text
            ...
            style={{
              ...
              width: 16,
              minWidth: 16,
              height: props.track.collapsed ? 24 : 28,
              alignItems: "center",
              justifyContent: "center",
              color: dawTheme.mutedForeground,
              cursor: "pointer",
            }}
          >{props.track.collapsed ? "▶" : "▼"}</text>
            ...
            <div style={{ display: "flex", gap: 4, height: 20 }}>
              <text
                ...
                style={{
                  ...
                  display: "flex",
                  flexDirection: "row",
                  width: props.track.collapsed ? 18 : 50,
                  height: 20,
                  alignItems: "center",
                  justifyContent: "center",
                  borderWidth: 1,
                  borderColor: dawTheme.border,
                  backgroundColor: props.track.muted ? dawTheme.timelineSurfaceMuted : dawTheme.amber,
                  color: props.track.muted ? dawTheme.mutedForeground : "#111111",
                  fontWeight: 800,
                  cursor: "pointer",
                }}
              >{String(props.track.number)}</text>
              <text
                ...
                style={{
                  ...
                  justifyContent: "center",
                  borderWidth: 1,
                  borderColor: props.track.soloed ? "#93c5fd" : dawTheme.border,
                  backgroundColor: props.track.soloed ? "#3b82f6" : dawTheme.timelineSurfaceMuted,
                  color: props.track.soloed ? "#050505" : dawTheme.foreground,
                  fontWeight: 700,
                  cursor: "pointer",
                }}
              >S</text>
              <text
                ...
                style={{
                  ...
                  justifyContent: "center",
                  borderWidth: 1,
                  borderColor: isRecordDisabled() ? "#7f1d1d" : dawTheme.red,
                  backgroundColor: props.track.armed ? dawTheme.red : dawTheme.timelineSurface,
                  color: props.track.armed ? "#09090b" : "#f87171",
                  fontWeight: 700,
                  opacity: isRecordDisabled() ? 0.55 : 1,
                  cursor: isRecordDisabled() ? "default" : "pointer",
                }}
              >R</text>
            </div>
              ...
              <Show when={!props.track.collapsed}>
                <text
                  ...
                  style={{
                    ...
                    justifyContent: "center",
                    borderWidth: 1,
                    borderColor: props.track.automationVisible ? "#f87171" : dawTheme.border,
                    backgroundColor: props.track.automationVisible ? "#ef4444e6" : dawTheme.timelineSurfaceMuted,
                    color: props.track.automationVisible ? "#09090b" : "#fca5a5",
                    fontWeight: 700,
                    cursor: "pointer",
                  }}
                >A</text>
                <text
                  ...
                  style={{
                    ...
                    borderWidth: 1,
                    borderColor: dawTheme.border,
                    backgroundColor: props.track.automationVisible ? dawTheme.timelineSurfaceMuted : dawTheme.timelineSurface,
                    color: props.track.automationVisible ? "#fecaca" : dawTheme.mutedForeground,
                    fontWeight: 700,
                    opacity: props.track.automationVisible ? 1 : 0.55,
                    cursor: props.track.automationVisible ? "pointer" : "default",
                  }}
                >+</text>
              </Show>
            </div>
