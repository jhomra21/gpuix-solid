...
if (!hasNativeTestRenderer) {
  ...
  app.renderer.clickTestId("compressor-reset")
  ...
  app.renderer.clickTestId("eq-reset")
  ...
  app.renderer.clickTestId("clip-drums-a")
  app.renderer.clickTextWithinTestId("bottom-panel", "CLIP")
  ...
  app.renderer.clickTestId("sample-gain-plus")
